/*
 ...
 This program's goal is to turn on and off the red LED, then blue LED, then yellow LED and finally green LED consecutively to give the impression it is a light chaser but with more 
 fluency by making the light come and go and by making a LED turn off at the same time the next one turns on.

 The main theme is the use of the delay varying its numbers to make the circuit more fluent.
